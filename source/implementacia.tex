...
Na konfiguráciu toho, ako správne spracovať jednotlivé typy dát sme pre každý zadefinovali jeho popisný objekt. Príklad takéhoto objektu pre interpretáciu predikátov je uvedený v ukážke \ref{prog:config_pred}. Jeho jednotlivé atribúty sú využívané v už opísaných častiach implementácie textových vstupov.
