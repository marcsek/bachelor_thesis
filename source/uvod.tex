...
Neskôr bola aplikácia rozšírená v bakalárskej práci Richarda Tótha \cite{toth2021} o Henkinovu-Hintikkovu hru a v práci Miroslava Balucha o jeden grafový pohľad so zámerom poskytnúť študentom alternatívny spôsob vizualizácie a manipulácie týchto štruktúr. Implementácia aplikácie sa však časom stala neaktuálnou a ťažko udržateľnou.
